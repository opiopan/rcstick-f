...
ctx.dump('outputs-pico2/pcb-top-base.png')
print(' end', flush=True)
...
print('dumping... ', end='', flush=True)
path = 'outputs-pico2/pcb-top-hmap.png'
ctx.dump(path)
...
print('dumping... ', end='', flush=True)
ctx.dump('outputs-pico2/pcb-top-mask.png')
print(' end', flush=True)
...
print('dumping... ', end='', flush=True)
ctx.dump('outputs-pico2/pcb-bottom-base.png')
print(' end', flush=True)
...
print('dumping... ', end='', flush=True)
path = 'outputs-pico2/pcb-bottom-hmap.png'
ctx.dump(path)
image = Image.open(path)
image.filter(ImageFilter.GaussianBlur(blur_radius)).save(path)
...
print('dumping... ', end='', flush=True)
ctx.dump('outputs-pico2/pcb-bottom-mask.png')
print(' end', flush=True)

#print('flipping... ', end='', flush=True)
base_image = Image.open('outputs-pico2/pcb-bottom-base.png')
hmap_image = Image.open('outputs-pico2/pcb-bottom-hmap.png')
mask_image = Image.open('outputs-pico2/pcb-bottom-mask.png')
ImageOps.mirror(base_image).save('outputs-pico2/pcb-bottom-base.png')
ImageOps.mirror(hmap_image).save('outputs-pico2/pcb-bottom-hmap.png')
ImageOps.mirror(mask_image).save('outputs-pico2/pcb-bottom-mask.png')
